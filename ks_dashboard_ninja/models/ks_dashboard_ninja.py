...
class KsDashboardNinjaBoard(models.Model):
    ...
    ks_dashboard_favourite_filters_ids = fields.One2many('ks_dashboard_ninja.favourite_filters','ks_dashboard_board_id',string="Dashboard Favourite Filters")
    ...
    ks_day_end_time = fields.Boolean(string='Day end time',help ='Users will get that day end time in custom date filter.')
    ...
    def ks_fetch_dashboard_data(self, ks_dashboard_id, ks_item_domain=False):
        ...
        dashboard_data = {
            ...
            'ks_dashboard_favourite_filter':ks_dashboard_rec.ks_prepare_dashboard_favourite_filter(),
            ...
            'ks_day_end_time':ks_dashboard_rec.ks_day_end_time
        }
    ...
    def ks_fetch_item_data(self, rec, params={}):
        ...
        item = {
            ...
            'ks_domain_2': rec.ks_convert_into_proper_domain(rec.ks_domain_2, rec, item_domain2),
            ...
            'ks_model_display_name_2': rec.ks_model_id_2.name,
    ...
    def ks_prepare_import_data_vals(self, data, menu_id):
        vals = {
            ...
            'ks_day_end_time':data['ks_day_end_time']
        }
        return vals
    ...
    def ks_prepare_dashboard_custom_domain(self):
        ...
        for rec in custom_filter_ids:
            data[str(rec.id)] = {
                ...
                'relation': rec.ks_domain_field_id.relation if rec.ks_domain_field_id.ttype in ['many2many','many2one','one2many'] else False,
                'special_data': {}
            }
    ...
    def ks_prepare_dashboard_favourite_filter(self):
        data = {}
        ks_favourite_filter_ids = self.env['ks_dashboard_ninja.favourite_filters'].search(
            [['id', 'in', self.ks_dashboard_favourite_filters_ids.ids],'|', ['ks_access_id', '=', self.env.user.id],
